...
class HumanTest {
    ...
    void testToString() {
        ...
        String expected = "Human{name='Rain', surname='Josh', year=1999, iq=99, schedule={Monday=go to Club, Thursday=just sleep, Friday=prepare for the party, Sunday=go to gym, Wednesday=code smth, Tuesday=read a book, Saturday=do whatever should be done}";
